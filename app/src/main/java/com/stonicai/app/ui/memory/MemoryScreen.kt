...
fun MemoryScreen(onBack: () -> Unit) {
    Column(
        ...
        val memories = listOf(
            ...
            "Persona" to "Stonic (switch in chat)"
        )
        ...
        LazyColumn(
            ...
            item {
                Surface(
                    ...
                    Column(Modifier.padding(18.dp)) {
                        ...
                        Text(
                            "Stonic remembers facts about you across conversations. Long-press any AI message to save it to Core Memory (coming in the next build).",
                            color = TextDim,
            ...
            items(memories.size) { idx ->
                val (k, v) = memories[idx]
                Surface(
                    color = BgPanel,
